...
-- Meals
CREATE TABLE meals (id SERIAL PRIMARY KEY, meal_id UUID NOT NULL, day_id UUID NOT NULL, meal_type VARCHAR(100) NOT NULL, meal_description VARCHAR(255) NOT NULL, calories NUMERIC NOT NULL, items JSONB);
