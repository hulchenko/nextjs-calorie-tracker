...
-- Daily Goals
CREATE TABLE days (id SERIAL PRIMARY KEY, day_id UUID NOT NULL UNIQUE, user_id UUID REFERENCES users(user_id) ON DELETE CASCADE, date DATE NOT NULL, calorie_target INT NOT NULL, calories_consumed INT DEFAULT 0, goal_met BOOLEAN DEFAULT false);
