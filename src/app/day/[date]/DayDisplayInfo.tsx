    ...
    return(
        <div>
            ...
            <div className='mt-20 flex flex-col items-center'>
                <p className='text-xl text-gray-600 font-bold'>Daily Target <span className={danger ? 'text-red-400' : warning ? 'text-orange-400' : ''}>{calories_consumed}</span> / <span className='text-teal-600'>{dailyTarget}</span></p>
